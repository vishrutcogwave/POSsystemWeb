...
const calculateGRN = async (
 ...
 const fetchGRNDetails = async (poNo: number) => {
  ...
  try {
    ...
    const res = await getPurchaseOrderGRNList(
      poNo,
      branchCode
    );

    console.log(
      "getPurchaseOrderGRNList Response:",
      res
    );
