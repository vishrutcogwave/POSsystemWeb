...
import { getCombinedOutletAndTableMasterList, getDailySalesReport } from "../api/services/products.service";
...
if (!outletId || (typeof outletId === "number" && isNaN(outletId))) return; // only block invalid numeric IDs

const res = await getDailySalesReport(fromDate, toDate, outletId);
