...
export default function UserRightsMaster() {
  ...
  const handleSave = async () => {
    try {
      ...
      const res =
        await insertUserPermissionAccessMaster(
          payload
        );
  ...
  return (
    <>
      ...
      <div className="h-[calc(100vh-100px)] overflow-y-auto bg-gray-50 p-4 md:p-6">
        {loading && <Loader />}
                ...
                (menu: any) => {
                  return (
                    ...
                    >
                      ...
                      <div className="px-4 py-4 bg-gray-100 rounded-t-xl">
